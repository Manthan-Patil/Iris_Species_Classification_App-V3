...
# Loading the dataset.
iris_df = pd.read_csv("Iris_Species_Classification-Data.csv")
...
# Creating a function 'prediction()' which accepts model, SepalLength, SepalWidth, PetalLength, PetalWidth as input and returns species name.
@st.cache()
...
# Adding title widget
st.sidebar.title("Iris Flower Species Predictor")      

# Adding 4 sliders and store the value returned by them in 4 separate variables. 
...
# Adding a select box in the sidebar with label 'Classifier' and with 3 options passed as a tuple ('Support Vector Machine', 'Logistic Regression', 'Random Forest Classifier').
# Storing the current value of this slider in a variable 'classifier'.
classifier = st.sidebar.selectbox("Classifier", ('Support Vector Machine', 'Logistic Regression', 'Random Forest Classifier'))

# When 'Predict' button is clicked, check which classifier is chosen and call 'prediction()' function.
if st.sidebar.button("Predict"):
  # Storing the predicted in a variable 'species_type' accuracy score of model in 'score' variable.
  ...
  # Printing the value of 'species_type' and 'score' variable using 'st.text()' function.
